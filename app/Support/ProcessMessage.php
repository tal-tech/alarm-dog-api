...
class ProcessMessage
{
     ...
     * @param array $params
     */
    public static function pack($cmd, $params): string
    {
        $packet = [
            'cmd' => $cmd,
            'params' => $params,
     ...
     */
    public static function unpack($packet): array
    {
     ...
     */
    public static function broadcastToAllWorkers(string $cmd, array $params = [], bool $ignoreCurrent = true): void
    {
        /** @var Server */
     ...
     * @param array $params 参数
     */
    public static function broadcastToTaskWorkers(string $cmd, array $params = []): void
    {
        /** @var Server */
        $server = ApplicationContext::getContainer()->get(Server::class);
     ...
     * @param bool $ignoreCurrent 是否忽略当前进程
     */
    public static function broadcastToEventWorkers(string $cmd, array $params = [], bool $ignoreCurrent = true): void
    {
        /** @var Server */
        $server = ApplicationContext::getContainer()->get(Server::class);
